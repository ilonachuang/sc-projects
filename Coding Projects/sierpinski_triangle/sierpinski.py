...
def main():
	"""
	TODO: This program draws a Sierpinski Triangle with recursion according to the order provided.
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	:param upper_left_y: the upper left y coordinate of order Sierpinski Triangle
	:return:
	"""
	# upper line
	...
	if order == 0:		# base case
		...
		sierpinski_triangle(order-1, length/2, upper_left_x+length/4, upper_left_y+length/2*0.866)	 # lower triangle
